package com.fwscott.webapis.smugmug.v1_2_2.methodgroups
{
	...
	import com.fwscott.webapis.smugmug.v1_2_2.AlbumSettings;
	...
	public class Albums
	{
		...
		public function get( nickName:String=null, heavy:Boolean=false, extras:String=null, sitePassword:String=null, shareGroup:Array = null ):void {
		...
		public function create( title:String, categoryID:int, albumSettings:AlbumSettings
			...
			MethodGroupHelper.invokeMethod( _service, create_result, 
								   ...
								   albumSettings.password != null,false,
								   ...
								   new NameValuePair( "ThemeID", albumSettings.themeID),
		...
		private function reSort_result( event:ResultEvent ):void {
		...
		private function deleteAlbum_result( event:ResultEvent ):void {
		...
		public function getStats( albumID:int, month:int, year:int, heavy:Boolean=false, extras:String=null ):void {
			// Let the Helper do the work to invoke the method
