package com.fwscott.webapis.smugmug.v1_2_2.methodgroups
{
	...
	import com.fwscott.webapis.smugmug.v1_2_2.ImageSettings;
	...
	public class Images
	{
		...
		public function get( albumID:int, albumKey:String, heavy:Boolean=false, extras:String=null, password:String=null, sitePassword:String=null ):void {
			// Let the Helper do the work to invoke the method
			MethodGroupHelper.invokeMethod( _service, get_result, 
								   "smugmug.images.get", 
								   ((sitePassword!=null) || (password!=null)),false,
		...
		private function getURLs_result( event:ResultEvent ):void {
		...
		private function getEXIF_result( event:ResultEvent ):void {
		...
		private function changePosition_result( event:ResultEvent ):void {
		...
		private function uploadFromURL_result( event:ResultEvent ):void {
		...
		private function deleteImage_result( event:ResultEvent ):void {
		...
		private function getStats_result( event:ResultEvent ):void {
		...
		private function applyWatermark_result( event:ResultEvent ):void {
		...
		private function crop_result( event:ResultEvent ):void {
		...
		private function removeWatermark_result( event:ResultEvent ):void {
		...
		private function rotate_result( event:ResultEvent ):void {
		...
		private function zoomThumbnail_result( event:ResultEvent ):void {
